...
public class CallFunctionMessageProcessorDebuggable
    extends CallFunctionMessageProcessor
    implements DebugInfoProvider
{


    public CallFunctionMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("content", "Content", (java.lang.Object.class), content, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("functionName", "Function name", (java.lang.String.class), functionName, muleEvent));
